...
1. `cp .env.example .env` and populate API keys. You can also set `DEFAULT_ENGINE`, `MISTRAL_DEFAULT_MODEL`, `SILICONFLOW_DEFAULT_MODEL`, or (if needed) `SILICONFLOW_BASE_URL` to change defaults without editing code.
