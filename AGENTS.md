# Project Agent Boundary: doc_to_md

## Identity

- Project: `doc_to_md`
- Repo path: `/home/ec2-user/work/doc_to_md`
- Remote: `https://github.com/ferryhe/doc_to_md`
- Worker role: 文档转换 CLI，负责 PDF/Office/HTML/扫描件 -> Markdown，并保留转换证据。
