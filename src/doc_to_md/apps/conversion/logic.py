...
from doc_to_md.engines.mineru_pro import MinerUProEngine
...
ENGINES_REQUIRING_MODEL = {"deepseekocr", "mistral", "markitdown", "paddleocr", "mineru", "mineru_pro", "docling", "marker", "opendataloader"}
